...
export default function PerfilMedico() {
  ...
  const validateForm = () => {
    ...
    if (!form.nroColegiatura || !form.nroColegiatura.trim()) e.nroColegiatura = 'C.O.P. requerido';
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input type="text" maxLength={5} value={form.nroColegiatura} onChange={e => setForm({...form, nroColegiatura: e.target.value.replace(/\D/g, '').slice(0, 5)})} className={`w-full border ${errors.nroColegiatura ? 'border-red-400' : 'border-slate-300'} rounded-lg px-3 py-2 text-sm focus:ring-[#0059B3]/40`} />
