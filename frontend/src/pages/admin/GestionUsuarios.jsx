...
export default function GestionUsuarios() {
  ...
  // CA1: Filtro de estado por defecto "ACTIVO"
    ...
    <AppLayout>
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div className="sm:flex sm:items-center sm:justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-slate-800">Listado de Personal</h1>
          ...
          <div className="mt-4 sm:mt-0">
            <button
              ...
              className="flex items-center gap-2 bg-[#8BC63F] hover:bg-[#78ae35] text-white px-4 py-2.5 rounded-xl font-medium transition-colors shadow-sm"
            >
              <Plus size={18} /> Crear usuario nuevo
            </button>
          </div>
        </div>
          ...
          <div className="flex gap-3">
            <div className="relative">
              ...
              <select
                ...
                className="pl-9 pr-8 py-2.5 border border-slate-200 rounded-xl text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#0059B3]/40 appearance-none text-slate-700"
              >
            ...
            <table className="w-full text-left text-sm text-slate-600">
              ...
              <tbody className="divide-y divide-slate-100">
                {loading ? (
                  ...
                  // CA8: Si no hay coincidencias, mostrar mensaje y botón
                  <tr>
                    <td colSpan="7" className="px-6 py-16 text-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-slate-500 mb-6 text-sm">
                          Intenta ajustar los filtros de búsqueda o registra un nuevo miembro del personal.
                        </p>
                        <button
                          onClick={() => navigate('/admin/usuarios/nuevo')}
                          className="flex items-center gap-2 bg-[#0059B3] hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-colors"
                        >
                          <Plus size={16} /> Crear usuario nuevo
                        </button>
                      </div>
                    </td>
                  </tr>
                  ...
                  paginatedUsers.map((u) => (
                    <tr key={u.usuario_id} className={`transition-colors ${getRowClass(u.estado)}`}>
                      ...
                      <td className="px-6 py-4 text-slate-600">
                        {/* CA4: Mostrar guion si no es doctor o no tiene especialidad */}
                        {u.nombre_rol === 'DOCTOR' && u.especialidad ? u.especialidad : '—'}
                      </td>
                      <td className="px-6 py-4">
