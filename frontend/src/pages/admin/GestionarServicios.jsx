...
export default function GestionarServicios() {
  ...
  const toggleEstado = async (servicio) => {
    ...
    try {
      await api.put(`/services/${servicio.servicio_id}`, { ...servicio, estado: nuevoEstado });
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              {!loading && servicios.length > 0 && (
                <div className="flex items-center gap-2 text-xs flex-shrink-0">
                  ...
                  <span className="px-2.5 py-1 bg-slate-100 text-slate-500 rounded-full font-medium">
                    Inactivos: {inactivos}
                  </span>
                </div>
              )}
          ...
          {editTarget && (
            <div className="fixed inset-0 z-50 flex items-center justify-center
              ...
              <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 relative">
                ...
                <h2 className="text-base font-bold text-[#0059B3] mb-4">Editar servicio</h2>
